...
class LoggingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMessages = channel.unary_unary(
                ...
                response_deserializer=logging__pb2.MessagesReply.FromString,
                _registered_method=True)
...
def add_LoggingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMessages': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=logging__pb2.MessagesReply.SerializeToString,
            ),
    }
...
class LoggingService(object):
    ...
    def GetMessages(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            logging__pb2.MessagesReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
